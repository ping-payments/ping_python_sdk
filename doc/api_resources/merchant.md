...
| ----------------- | ------ | --------------------- | ----------- |
| `merchant_object` | Object | merchant_name: String |

organisation: Object {
country: String,
organisation_number: String
} | An object containing a name for the new merchant and the organisationnumber for the organisation that merchant is part of |
